...
abstract class DispatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function dataProviderTestFoundDispatches()
    {
        $cases = [];
    ...
    public function dataProviderTestNotFoundDispatches()
    {
        $cases = [];
    ...
    public function dataProviderTestMethodNotAllowedDispatches()
    {
        $cases = [];
